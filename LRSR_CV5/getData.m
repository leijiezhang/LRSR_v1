...
switch lower(set_name)
    case {lower('PIE')}
        load('E:\WrokSpace\Matlab\LSR1\datasets\PIE_all.mat');
    case {lower('UMIST')}
        load('E:\WrokSpace\Matlab\LSR1\datasets\UMIST.mat');
    case {lower('YaleB')}
        load('E:\WrokSpace\Matlab\LSR1\datasets\YaleB_32x32.mat');
    case {lower('MNIST')}
        load('E:\WrokSpace\Matlab\LSR1\datasets\MNISTOrig.mat');
    case {lower('Yale')}
        load('E:\WrokSpace\Matlab\LSR1\datasets\Yale_32x32.mat');
     case {lower('COIL')}
        load('E:\WrokSpace\Matlab\LSR1\datasets\coil20.mat');
     case {lower('ISOlet')}
        load('E:\WrokSpace\Matlab\LSR1\datasets\ISOlet.mat');
     case {lower('USPS')}
        load('E:\WrokSpace\Matlab\LSR1\datasets\usps.mat');
     otherwise
...
for i=1:n_class
    ...
    labelIdx=labelIdx(randperm(n_smpl_perC));
