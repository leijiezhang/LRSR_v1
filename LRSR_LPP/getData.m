...
switch lower(set_name)
    case {lower('PIE')}
        load('D:\workspace\MATLAB\LRSR_LPP\datasets\PIE_all.mat');
    case {lower('UMIST')}
        load('D:\workspace\MATLAB\LRSR_LPP\datasets\UMIST.mat');
    case {lower('YaleB')}
        load('D:\workspace\MATLAB\LRSR_LPP\datasets\YaleB_32x32.mat');
    case {lower('MNIST')}
        load('D:\workspace\MATLAB\LRSR_LPP\datasets\MNISTOrig.mat');
    case {lower('Yale')}
        load('D:\workspace\MATLAB\LRSR_LPP\datasets\Yale_32x32.mat');
     case {lower('COIL')}
        load('D:\workspace\MATLAB\LRSR_LPP\datasets\coil20.mat');
     case {lower('ISOlet')}
        load('D:\workspace\MATLAB\LRSR_LPP\datasets\ISOlet.mat');
     case {lower('USPS')}
        load('D:\workspace\MATLAB\LRSR_LPP\datasets\usps.mat');
     otherwise
